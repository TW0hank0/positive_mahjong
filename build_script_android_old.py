...
# 包名
PACKAGE_ID = "io.github.positive_mahjong.tw0hank0"
...
def main() -> None:
    ...
    """
    print("=" * 50)
    print("Positive Mahjong (pmj_client) Android 編譯腳本")
    print(f"開發者：TW0hank0 | 包名：{PACKAGE_ID}")
    print("=" * 50)

    # 1. 檢查當前目錄是否包含 Cargo.toml (Workspace 根目錄)
    if os.path.exists("Cargo.toml") is False:
        print(
