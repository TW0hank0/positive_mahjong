...
use iced_core::{self, Layout, Shell, Widget};
use iced_core::{Background, Color, Element, Event, Length, Radians, Rectangle, Size, Vector};
...
impl<'a, Message, Theme> Widget<Message, Theme, WgpuRenderer> for Circular<'a, Theme>
where
    Message: 'a + Clone,
    Theme: StyleSheet,
{
    ...
    fn draw(
        ...
        renderer.with_translation(Vector::new(bounds.x, bounds.y), |renderer| {
            use iced_widget::graphics::geometry::Renderer as _;
...
impl<'a, Message, Theme> From<Circular<'a, Theme>> for Element<'a, Message, Theme, WgpuRenderer>
where
    Message: Clone + 'a,
    Theme: StyleSheet + 'a,
{
...
impl StyleSheet for iced_core::theme::Theme {
    type Style = ();
