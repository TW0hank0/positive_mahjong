...
pub fn get_licenses() -> Vec<LicenseInfo> {
  return vec![
    ...
    LicenseInfo {
        ...
        authors: vec!["The AccessKit contributors"] 
    },
    LicenseInfo {
    ...
    LicenseInfo {
        ...
        version: "0.2.21",
        license: "MIT OR Apache-2.0",
        authors: vec!["Zakarum <zaq.dev@icloud.com>"] 
    },
    LicenseInfo {
    ...
    LicenseInfo {
        ...
        version: "0.29.0",
        license: "Apache-2.0 OR MIT",
        authors: vec!["Alberto Tirla <albertotirla@gmail.com>", "DataTriny <datatriny@gmail.com>", "Luuk van der Duim <luukvanderduim@gmail.com>", "Michael Connor Buchan <mikey@blindcomputing.org>", "Tait Hoyem <tait@tait.tech>"] 
    },
    LicenseInfo {
        name: "atspi-common",
        version: "0.13.0",
    ...
    LicenseInfo {
        ...
        version: "2.0.1",
        license: "MIT",
        authors: vec!["Ty Overby <ty@pre-alpha.com>", "Zoey Riordan <zoey@dos.cafe>", "Victor Koenders <bincode@trangar.com>"] 
    },
    LicenseInfo {
        name: "bindgen",
        version: "0.72.1",
        license: "BSD-3-Clause",
        authors: vec!["Jyun-Yan You <jyyou.tw@gmail.com>", "Emilio Cobos Álvarez <emilio@crisal.io>", "Nick Fitzgerald <fitzgen@gmail.com>", "The Servo project developers"] 
    },
    LicenseInfo {
        name: "bit-set",
        version: "0.8.0",
    ...
    LicenseInfo {
        ...
        version: "1.6.0",
        license: "MIT OR Apache-2.0",
        authors: vec!["Near Inc <hello@near.org>"] 
    },
    LicenseInfo {
        name: "built",
        version: "0.8.0",
    ...
    LicenseInfo {
        ...
        version: "1.2.1",
        license: "MIT OR Apache-2.0",
        authors: vec!["Matt Brubeck <mbrubeck@limpet.net>"] 
    },
    LicenseInfo {
        name: "bytemuck",
        version: "1.25.0",
    ...
    LicenseInfo {
        ...
        version: "0.6.0",
        license: "Apache-2.0/MIT",
        authors: vec!["Jethro Beekman <jethro@jbeekman.nl>"] 
    },
    LicenseInfo {
        name: "cfg-if",
        version: "1.0.4",
    ...
    LicenseInfo {
        ...
        version: "1.8.1",
        license: "Apache-2.0",
        authors: vec!["Kyle Mayes <kyle@mayeses.com>"] 
    },
    LicenseInfo {
        name: "clipboard-win",
        version: "5.4.1",
    ...
    LicenseInfo {
        ...
        version: "0.6.2",
        license: "MIT",
        authors: vec!["marmeladema <xademax@gmail.com>"] 
    },
    LicenseInfo {
        name: "cmake",
        version: "0.1.57",
    ...
    LicenseInfo {
        ...
        version: "0.10.0",
        license: "MIT",
        authors: vec!["rutrum <dave@rutrum.net>"] 
    },
    LicenseInfo {
        name: "copypasta",
        version: "0.10.2",
        license: "MIT / Apache-2.0",
        authors: vec!["Christian Duerr <contact@christianduerr.com>"] 
    },
    LicenseInfo {
    ...
    LicenseInfo {
        ...
        version: "0.5.10",
        license: "MIT/Apache-2.0",
        authors: vec!["Nika Layzell <nika@thelayzells.com>", "Olivier Goffart <olivier.goffart@slint-ui.com>"] 
    },
    LicenseInfo {
        name: "cpp_build",
        version: "0.5.10",
    ...
    LicenseInfo {
        ...
        version: "0.3.2",
        license: "MIT OR Apache-2.0",
        authors: vec!["Simon Sapin <simon.sapin@exyr.org>"] 
    },
    LicenseInfo {
        name: "derive_builder",
        version: "0.20.2",
    ...
    LicenseInfo {
        ...
        version: "0.14.2",
        license: "MIT",
        authors: vec!["Tyler Slabinski <slabity@slabity.dev>", "Victoria Brekenfeld <crates-io@drakulix.de>"] 
    },
    LicenseInfo {
        name: "drm-ffi",
        version: "0.9.1",
        license: "MIT",
        authors: vec!["Tyler Slabinski <tslabinski@slabity.net>"] 
    },
    LicenseInfo {
        name: "drm-fourcc",
        version: "2.2.0",
        license: "MIT",
        authors: vec!["Daniel Franklin <daniel@danielzfranklin.org>"] 
    },
    LicenseInfo {
        name: "drm-sys",
        version: "0.8.1",
    ...
    LicenseInfo {
        ...
        version: "0.20.4",
        license: "MIT OR Apache-2.0",
        authors: vec!["Peter Todorov <ptodorov@cytec.bg>", "Adam Nemecek <adamnemecek@gmail.com>"] 
    },
    LicenseInfo {
        name: "field-offset",
        version: "0.3.6",
        license: "MIT OR Apache-2.0",
        authors: vec!["Diggory Blake <diggsey@googlemail.com>"] 
    },
    LicenseInfo {
        name: "filetime",
        version: "0.2.27",
    ...
    LicenseInfo {
        ...
        version: "0.9.0",
        license: "MIT",
        authors: vec!["Mike Dilger <mike@mikedilger.com>"] 
    },
    LicenseInfo {
        name: "fnv",
        version: "1.0.7",
    ...
    LicenseInfo {
        ...
        version: "0.9.3",
        license: "MIT OR Apache-2.0 OR Zlib",
        authors: vec!["Joe Cumbo <mooman219@gmail.com>"] 
    },
    LicenseInfo {
        name: "fontique",
        version: "0.7.0",
    ...
    LicenseInfo {
        ...
        version: "0.18.0",
        license: "MIT",
        authors: vec!["Victoria Brekenfeld <github@drakulix.de>"] 
    },
    LicenseInfo {
        name: "gbm-sys",
        version: "0.4.0",
        license: "MIT",
        authors: vec!["Drakulix (Victor Brekenfeld)"] 
    },
    LicenseInfo {
        name: "gethostname",
        version: "1.1.0",
    ...
    LicenseInfo {
        ...
        version: "0.2.1",
        license: "MIT OR Apache-2.0",
        authors: vec!["Jeremie Drouet <jeremie.drouet@gmail.com>"] 
    },
    LicenseInfo {
        name: "http",
        version: "1.4.0",
    ...
    LicenseInfo {
        ...
        version: "0.14.0",
        license: "MIT",
        authors: vec!["Maid Dog <maiddogsrl@gmail.com>"] 
    },
    LicenseInfo {
        name: "imgref",
        version: "1.12.0",
    ...
    LicenseInfo {
        ...
        version: "0.9.1",
        license: "MIT",
        authors: vec!["Drakulix (Victoria Brekenfeld)"] 
    },
    LicenseInfo {
        name: "input-sys",
        version: "1.18.0",
        license: "MIT",
        authors: vec!["Victoria Brekenfeld (Drakulix) <github@drakulix.de>"] 
    },
    LicenseInfo {
        name: "integer-sqrt",
        version: "0.1.5",
        license: "Apache-2.0/MIT",
        authors: vec!["Richard Dodd <richard.o.dodd@gmail.com>", "Joseph Richey", "Sergei Shulepov"] 
    },
    LicenseInfo {
    ...
    LicenseInfo {
        ...
        version: "1.5.0",
        license: "MIT OR Apache-2.0",
        authors: vec!["Marvin Löbel <loebel.marvin@gmail.com>"] 
    },
    LicenseInfo {
        name: "leb128fmt",
        version: "0.1.0",
    ...
    LicenseInfo {
        ...
        version: "0.1.4",
        license: "MIT",
        authors: vec!["David Cuddeback <david.cuddeback@gmail.com>"] 
    },
    LicenseInfo {
        name: "lilt",
        version: "0.8.1",
    ...
    LicenseInfo {
        ...
        version: "0.5.6",
        license: "MIT/Apache-2.0",
        authors: vec!["Stepan Koltsov <stepan.koltsov@gmail.com>", "Andrew Paseltiner <apaseltiner@gmail.com>"] 
    },
    LicenseInfo {
    ...
    LicenseInfo {
        ...
        version: "0.9.10",
        license: "MIT OR Apache-2.0",
        authors: vec!["Dan Burkert <dan@danburkert.com>", "Yevhenii Reizner <razrfalcon@gmail.com>", "The Contributors"] 
    },
    LicenseInfo {
        name: "memoffset",
        version: "0.9.1",
    ...
    LicenseInfo {
        ...
        version: "0.2.1",
        license: "MIT/Apache-2.0",
        authors: vec!["Alex Huszagh <ahuszagh@gmail.com>"] 
    },
    LicenseInfo {
        name: "miniz_oxide",
        version: "0.8.9",
    ...
    LicenseInfo {
        ...
        version: "0.30.1",
        license: "MIT",
        authors: vec!["The nix-rust Project Developers"] 
    },
    LicenseInfo {
        name: "nom",
        version: "7.1.3",
    ...
    LicenseInfo {
        ...
        version: "1.1.0",
        license: "MIT",
        authors: vec!["Olivier Goffart <ogoffart@sixtyfps.io>"] 
    },
    LicenseInfo {
        name: "piper",
        version: "0.2.4",
    ...
    LicenseInfo {
        ...
        version: "0.13.1",
        license: "MIT",
        authors: vec!["Raph Levien <raph.levien@gmail.com>", "Marcus Klaas de Vries <mail@marcusklaas.nl>"] 
    },
    LicenseInfo {
    ...
    LicenseInfo {
        ...
        version: "0.2.12",
        license: "MIT",
        authors: vec!["Olivier Goffart <olivier.goffart@slint.dev>"] 
    },
    LicenseInfo {
        name: "quick-error",
        version: "2.0.1",
    ...
    LicenseInfo {
        ...
        version: "1.12.3",
        license: "MIT OR Apache-2.0",
        authors: vec!["The Rust Project Developers", "Andrew Gallant <jamslam@gmail.com>"] 
    },
    LicenseInfo {
        name: "regex-automata",
        version: "0.4.14",
    ...
    LicenseInfo {
        ...
        version: "1.0.2",
        license: "MIT/Apache-2.0",
        authors: vec!["Frank Denis <github@pureftpd.org>"] 
    },
    LicenseInfo {
        name: "skia-bindings",
        version: "0.90.0",
        license: "MIT",
        authors: vec!["LongYinan <lynweklm@gmail.com>", "Armin Sander <armin@replicator.org>"] 
    },
    LicenseInfo {
        name: "skia-safe",
        version: "0.90.0",
        license: "MIT",
        authors: vec!["Armin Sander <armin@replicator.org>"] 
    },
    LicenseInfo {
        name: "skrifa",
        version: "0.37.0",
    ...
    LicenseInfo {
        ...
        version: "0.3.5",
        license: "MIT OR Apache-2.0",
        authors: vec!["Aleksey Kladov <aleksey.kladov@gmail.com>", "Lukas Wirth <lukastw97@gmail.com>"] 
    },
    LicenseInfo {
        name: "snafu",
        version: "0.8.9",
        license: "MIT OR Apache-2.0",
        authors: vec!["Jake Goulding <jake.goulding@gmail.com>"] 
    },
    LicenseInfo {
        name: "snafu-derive",
        version: "0.8.9",
    ...
    LicenseInfo {
        ...
        version: "0.1.1",
        license: "Apache-2.0 OR MIT",
        authors: vec!["paulkernfeld <me@paulkernfeld.com>"] 
    },
    LicenseInfo {
        name: "spirv",
    ...
    LicenseInfo {
        ...
        version: "0.27.2",
        license: "MIT",
        authors: vec!["Peter Glotfelty <peter.glotfelty@microsoft.com>"] 
    },
    LicenseInfo {
        name: "strum_macros",
        version: "0.27.2",
    ...
    LicenseInfo {
        ...
        version: "1.1.1",
        license: "MIT OR Apache-2.0",
        authors: vec!["Aleksey Kladov <aleksey.kladov@gmail.com>", "Christopher Durham (CAD97) <cad97@cad97.com>"] 
    },
    LicenseInfo {
        name: "thiserror",
        version: "1.0.69",
    ...
    LicenseInfo {
        ...
        version: "3.5.0",
        license: "MIT OR Apache-2.0",
        authors: vec!["Andrey Zheleznov <zheland.net@gmail.com>"] 
    },
    LicenseInfo {
        name: "typemap-ors",
        version: "1.0.0",
    ...
    LicenseInfo {
        ...
        version: "0.9.3",
        license: "MIT",
        authors: vec!["David Cuddeback <david.cuddeback@gmail.com>", "Victoria Brekenfeld <github@drakulix.de>"] 
    },
    LicenseInfo {
        name: "uds_windows",
        version: "1.1.0",
    ...
    LicenseInfo {
        ...
        version: "0.1.4",
        license: "MIT/Apache-2.0",
        authors: vec!["Charles Lew <crlf0710@gmail.com>", "Manish Goregaokar <manishsmail@gmail.com>"] 
    },
    LicenseInfo {
        name: "unicode-script",
        version: "0.5.8",
    ...
    LicenseInfo {
        ...
        version: "0.1.0",
        license: "MIT/Apache-2.0",
        authors: vec!["Evgeniy Reizner <razrfalcon@gmail.com>"] 
    },
    LicenseInfo {
        name: "unicode-width",
        version: "0.2.2",
    ...
    LicenseInfo {
        ...
        version: "0.0.4",
        license: "MIT OR Apache-2.0",
        authors: vec!["Victor Koenders <bincode@trang.ar>"] 
    },
    LicenseInfo {
        name: "url",
        version: "2.5.8",
    ...
    LicenseInfo {
        ...
        version: "0.9.3",
        license: "MIT",
        authors: vec!["quininer kel <quininer@live.com>"] 
    },
    LicenseInfo {
        name: "x11-dl",
        version: "2.21.0",
    ...
    LicenseInfo {
        ...
        version: "1.6.1",
        license: "MIT OR Apache-2.0",
        authors: vec!["Steven Allen <steven@stebalien.com>"] 
    },
    LicenseInfo {
        name: "xcursor",
        version: "0.3.10",
    ...
    LicenseInfo {
        ...
        version: "0.9.0",
        license: "MIT",
        authors: vec!["Remi THEBAULT <remi.thebault@gmail.com>"] 
    },
    LicenseInfo {
        name: "xkbcommon-dl",
        version: "0.4.2",
    ...
    LicenseInfo {
        ...
        version: "6.0.0",
        license: "MIT",
        authors: vec!["Austin Bonander <austin.bonander@gmail.com>", "The Servo Project Developers", "YesLogic Pty. Ltd. <info@yeslogic.com>"] 
    },
    LicenseInfo {
        name: "yoke",
        version: "0.8.1",
    ...
    LicenseInfo {
        ...
        version: "0.5.2",
        license: "MIT",
        authors: vec!["Luuk van der Duim <luukvanderduim@gmail.com>", "Tait Hoyem<tait@tait.tech>"] 
    },
    LicenseInfo {
        name: "zbus-lockstep-macros",
        version: "0.5.2",
        license: "MIT",
        authors: vec!["Luuk van der Duim <luukvanderduim@gmail.com>"] 
    },
    LicenseInfo {
        name: "zbus_macros",
        version: "5.13.2",
